/*****************************************************
Можно использовать для тестирования Arduino на
 тактирование 16 мгц
 и мигание  светодиодом Т=2сек на PB2
! Прошёл первый пуск (Hello !) LED 16 * 2
Устанавливаем задержки  lcd_cjm и _dat (40-100)
и , безуспешно боремся с мусором от reseta
...
Команда №4 — 0x0D – включить дисплей
*/
...
lcd_dat(',');
lcd_dat(' ');
lcd_dat('W');lcd_dat('o');lcd_dat('r');lcd_dat('l');lcd_dat('d');
lcd_dat('!');
